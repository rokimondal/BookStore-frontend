            ...
            <div className="w-full max-w-sm mx-auto bg-white shadow-lg rounded px-7 pt-6 pb-8 mb-4">
                ...
                <div className="mt-4">
                    <button
                        ...
                        className="bg-blue-400 flex flex-wrap text-white justify-center items-center py-2 px-3 rounded-md gap-2 bg-secondary w-full hover:bg-blue-800 hover:shadow-md hover:shadow-blue-300">
                        <BsGoogle />
                        sign in with Google
                    </button>
                </div>
